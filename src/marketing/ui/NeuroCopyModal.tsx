...
export const NeuroCopyModal: React.FC<NeuroCopyModalProps> = ({
  isOpen,
  onClose,
  onUseCopy,
}) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-2xl animate-fade-in"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center gap-3 mb-6">
          <Sparkles className="text-purple-500" size={28} />
          <h2 className="text-2xl font-bold text-gray-800">
            NeuroCopy: Gerador de Anúncios
          </h2>
        </div>
        ...
        <div className="flex gap-2 mb-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="px-6 py-2 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 disabled:bg-purple-300"
          >
            {isLoading ? (
        ...
        {generatedCopy && (
          <div className="space-y-4 animate-fade-in">
            <div>
              ...
              <textarea
                readOnly
                value={generatedCopy.titles}
                rows={3}
                className="w-full p-2 mt-1 bg-gray-50 rounded-md border"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                readOnly
                value={generatedCopy.descriptions}
                rows={3}
                className="w-full p-2 mt-1 bg-gray-50 rounded-md border"
              />
            </div>
            ...
            <div className="flex justify-end">
              <span className="text-xs px-3 py-1 rounded-full bg-gray-100 text-gray-600 border">
                Fonte: {generatedCopy.source}
              </span>
            </div>
          </div>
        )}
        ...
        <div className="mt-8 flex justify-between items-center">
          ...
          {generatedCopy && (
            <button
              ...
              className="flex items-center gap-2 px-6 py-2 rounded-lg text-white bg-green-600 hover:bg-green-700 font-bold"
            >
              <Send size={16} />
